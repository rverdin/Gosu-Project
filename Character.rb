class Character
  ...
  def initialize(x, y)
    ...
    @shoot_right = Image.load_tiles($window, "media/Character/character_shooting2.png", 400, 300, false)
    @shoot_left = Image.load_tiles($window, "media/Character/character_shooting2_left.png", 116, 132, false)
    @sprite = @stand_right
    @dir = :right
